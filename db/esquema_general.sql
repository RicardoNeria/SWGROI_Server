-- SWGROI: Esquema general unificado para MySQL 8+
-- Contiene: 0001_inicial + 0002_auditoria + 0003_documentos
-- Copiar y pegar completo en MySQL Workbench
...
-- Servicios técnicos (almacena JSON de respuestas de encuesta)
...
CREATE TABLE IF NOT EXISTS auditoria (
  ...
  CONSTRAINT fk_aud_usuario FOREIGN KEY (IdUsuario) REFERENCES usuarios(IdUsuario)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS Documentos (
  ...
  AlmacenamientoRuta VARCHAR(500) NOT NULL,
...
CREATE TABLE IF NOT EXISTS DocumentoVersiones (
...
CREATE INDEX IF NOT EXISTS idx_documentos_nombre ON Documentos(NombreArchivo);
