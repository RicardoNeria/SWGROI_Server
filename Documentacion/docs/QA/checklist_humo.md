...
## 12) Gestión Documental (nuevo)
- Subir un PDF de prueba (≤10MB) con categoría "Operativo" y etiqueta "demo".
- Ver que aparezca en la tabla y descargarlo.
- Subir nuevamente el mismo archivo como nueva versión: debe rechazarlo con `duplicate_version`.
- Subir una nueva versión diferente: la versión debe incrementar y la descarga entregar la más reciente.
